...
<head>
    ...
    @vite(['resources/css/style_noti.css', 'resources/js/app.js'])
...
<body>
    ...
    <main class="contenedor">
        ...
        <div class="notificaciones">
            ...
            <div class="noti-left">
                <img src="{{ asset('img/gif2.gif') }}" alt="Notificaciones" class="noti-icon" loading="lazy">
            </div>
    ...
    <script>
        ...
        setTimeout(() => {
            ...
            if (t) t.classList.add('hidden');
            const o = document.getElementById('systemToastOverlay');
            if (o) { o.classList.remove('show'); o.classList.add('hidden'); }
        }, 4000);
    </script>
</body>
